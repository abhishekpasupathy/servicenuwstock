...
export default function BacktestPage() {
  ...
  return (
    <div className="space-y-4">
      <section className="terminal-card flex items-center gap-3 p-4"><select className="bg-[var(--bg-tertiary)] p-2"><option>Composite Score</option><option>SMA Crossover</option><option>RSI Mean Reversion</option><option>MACD Signal</option></select><input type="date" defaultValue="2022-01-01" className="bg-[var(--bg-tertiary)] p-2" /><input type="date" defaultValue="2024-12-31" className="bg-[var(--bg-tertiary)] p-2" /><input defaultValue="10000" className="bg-[var(--bg-tertiary)] p-2" /><button onClick={run} className="rounded bg-[var(--green)] px-4 py-2 text-[var(--bg-primary)]">Run Backtest</button></section>
